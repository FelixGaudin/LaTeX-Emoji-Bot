...
convert -border 80 -density 500 -quality 300 -trim +repage -border 40 -bordercolor '#36393f' $1.pdf $1.png
...
convert -background '#36393f' -extent ${newwidth}x${height} $1.png $1.png
